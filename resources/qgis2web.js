...
map.getView().fit([11703028.966953, -580345.260361, 11721279.047129, -570104.483701], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://docs.google.com/spreadsheets/d/1LsiRvv2OAwoXmVIMKSu5q0id0l7x3z84dopBBlbyugI/edit?usp=sharing"><div><h1>REKAPITULASI </h1></div></a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://drive.google.com/drive/folders/1n4TOMj0v_Phsez8yHsnX2Y-xombis7s0">DATASET</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://docs.google.com/spreadsheets/d/18q4Ecd0A0pR7lT_qIRQF5Rte1XuSVBxRJjwvVWLjzj0/edit#gid=0">LIST DATASET</a>';
